...
### Basic Usage
```bash
swift run SwiftClassifier
```

### Custom Text Input
```bash
swift run SwiftClassifier "Your text to classify here"
```

### Examples
```bash
# Sports classification
swift run SwiftClassifier "NBA Finals: Celtics Defeat Mavericks in Game 5 to Win Championship"

# Technology classification
swift run SwiftClassifier "Apple announces new iPhone with advanced AI capabilities"

# Politics classification
swift run SwiftClassifier "President signs new legislation on healthcare reform"

# Business classification
swift run SwiftClassifier "Stock market reaches new highs as tech companies report strong earnings"

# Entertainment classification
swift run SwiftClassifier "New Marvel movie breaks box office records in opening weekend"
```
